...
STRICT_FORBIDDEN_PHRASES = [
    ...
    # 等级/材质安全/功能宣称
    "食品级", "母婴级", "304", "316", "纳米", "抗菌", "抑菌", "除菌", "杀菌", "灭菌", "无菌", "防菌", "消菌",
    # 药品/农药/绝对化/销量
    ...
    # 违规赔付承诺：保留正常售后表达，但禁止无限赔付/兜底式承诺
    "包赔到底", "赔到底", "赔付到底", "无限包赔", "无限赔付", "一直包赔", "一直赔付", "全程包赔", "赔到满意", "包赔到满意", "包赔到你满意",
    # 迷信宗教类
