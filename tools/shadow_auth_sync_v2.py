#!/usr/bin/env python3
"""P1-A reconciliation entry point with duplicate Feishu-code quarantine."""
...
def run() -> int:
    parser = argparse.ArgumentParser(description="Read-only LiveClipper P1-A shadow reconciliation")
    ...
    parser.add_argument("--apply", action="store_true", help="write only the local shadow database")
    ...
    try:
        ...
        for locator, payload in feishu_records:
            ...
            if unchanged:
            ...
            elif code and code in first_feishu_code:
                ...
                # Importer will find the source object created above and transform it.
