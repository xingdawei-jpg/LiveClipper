# -*- coding: utf-8 -*-
"""M2-A 单素材测试：韩系学院风连衣裙 → 策略 → 版本选择 → LLM 叙事计划

重点验证：角色重映射（尤其「裙子太短会走光」是否被重映射成 hook）。
"""
...
SRT_PATH = r"C:\工作\小贤\单品素材\7-22单品\AYOBE_小贤 7月22日09_00新品 韩系学姐清纯减龄感学院风连衣裙\AYOBE_小贤 7月22日09_00新品 韩系学姐清纯减龄感学院风连衣裙_1.srt"
PRODUCT = "韩系学院风连衣裙"
